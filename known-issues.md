...
| Level | Description |
|---|---|
| P0 | Audit log fails to write; compliance gap |
| P1 | Log corrupted or unreadable by SIEM |
| P2 | Non-critical event type missing |
...
Use the Molecule-AI/internal issue tracker. Tag with `plugin-molecule-audit`.
